...
public class MenuClickListenerHandler extends ClickListener {
    ...
    private void handleItemClick(){
        if(gameWorld.getSelectedCharacter() != null &&
                gameWorld.getGameWorldState() == GameWorld.GameWorldState.wattingAction){
    ...
    private void handleUseClick(){
        if(gameWorld.getGameWorldState() == GameWorld.GameWorldState.wattingAction){
            ...
            getGameWorld().setGameWorldState(GameWorld.GameWorldState.wattingAction);
